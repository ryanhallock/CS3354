...
export default function MyFlashcards() {
  ...
  return (
    <div className="relative min-h-screen p-5">
      ...
      <button
        className="absolute bottom-5 right-5 w-12.5 h-12.5 rounded-full bg-primary text-white border-none text-2xl cursor-pointer flex items-center justify-center shadow-[0_2px_10px_rgba(0,0,0,0.2)] hover:bg-[#16207a]"
